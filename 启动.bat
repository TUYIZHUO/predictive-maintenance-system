...
start "设备维护系统-前端" cmd /k "python -m streamlit run frontend/app.py --server.port 8501 --server.headless true"
...
echo.
echo 停止时请关闭「设备维护系统-后端」「设备维护系统-前端」两个窗口。
echo.
pause
